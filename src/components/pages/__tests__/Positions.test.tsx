...
const mockPositions: Position[] = [
  {
    key: "pos1",
    title: "Position 1",
    persons: [{ key: "per1", name: "Person 1" }],
    maxVotesPerBallot: 1,
    maxVacancies: 1,
  },
];
...
describe("Positions", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    (usePositionsStore as unknown as vi.Mock).mockReturnValue({
      positions: mockPositions,
      setPositions: mockSetPositions,
    });
    (useBallotStore as unknown as vi.Mock).mockReturnValue({
      ballots: [],
    });
  });
